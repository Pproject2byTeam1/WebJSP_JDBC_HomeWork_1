                              ...
                              <form action="Ex03_MemberEditok.do" method="post">
                                 ...
                                 <div>
                                    <table style="margin:auto;">
                                       ...
                                       <tr>
                                          <td>비번</td>
                                          <td class="form-control" readonly>${member.pwd}</td>
                                       </tr>
                                       <tr>
                                          <td>이름</td>
                                          <td>
                                       ...
                                       <tr>
                                          <td>성별</td>
                                          <td> 
                                             <input type="radio" class="form" name="gender" id="gender" value="여" <c:if test="${member.gender == '여 '}">checked</c:if>>여
                                             <input type="radio" class="form" name="gender" id="gender" value="남" <c:if test="${member.gender == '남 '}">checked</c:if>>남
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>이메일</td>
                                       ...
                                       <tr>
                                          ...
                                          <input type="button" value="리스트로 돌아가기" onClick="location.href='Ex03_Memberlist.do'" class="btn btn-primary"> 
                                    </table>
                                    </div>
                                 </div>
                                 </div>
